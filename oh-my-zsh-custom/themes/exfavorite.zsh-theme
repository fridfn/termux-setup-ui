function theme_precmd {
  ...
  local promptsize=${#${(%):---( ExFavorite | Dev )---()--}}
...
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{$fg[cyan]%} %{%GΩ%}"
...
${PR_GREEN}%${PR_PWDLEN}<...<%~%<<\
${PR_GREY})$(virtualenv_prompt_info)$(ruby_prompt_info)${PR_CYAN}${PR_HBAR}${PR_HBAR}${(e)PR_FILLBAR}${PR_HBAR}${PR_MAGENTA}( ExFavorite | Dev )${PR_CYAN}${PR_HBAR}${PR_URCORNER}\
